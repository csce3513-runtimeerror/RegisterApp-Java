...
public class EmployeeRestController extends BaseRestController {
	...
	public @ResponseBody ApiResponse createEmployee(@RequestBody final Employee employee,
	...
	public @ResponseBody ApiResponse updateEmployee(@PathVariable final UUID employeeId,
			@RequestBody final Employee employee, final HttpServletRequest request,
